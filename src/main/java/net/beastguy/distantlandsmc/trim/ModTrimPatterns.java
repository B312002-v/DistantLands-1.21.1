...
public class ModTrimPatterns {
    public static final ResourceKey<TrimPattern> BEAST = ResourceKey.create(Registries.TRIM_PATTERN,
            ResourceLocation.fromNamespaceAndPath(DistantLandsMod.MODID, "beast"));

    public static void bootstrap(BootstrapContext<TrimPattern> context) {
        register(context, ModItems.BEAST_SMITHING_TEMPLATE, BEAST);
    }

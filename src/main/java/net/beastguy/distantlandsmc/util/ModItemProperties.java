...
public class ModItemProperties {
    public static void addCustomItemProperties() {
        ...
        makeCustomEmeraldBow(ModItems.CURSED_RUBY_BOW.get());
    ...
    private static void makeCustomEmeraldBow(Item item) {
        ItemProperties.register(item, ResourceLocation.withDefaultNamespace("pull"), (p_344163_, p_344164_, p_344165_, p_344166_) -> {
            if (p_344165_ == null) {
                return 0.0F;
            } else {
                return p_344165_.getUseItem() != p_344163_ ? 0.0F : (float)(p_344163_.getUseDuration(p_344165_) - p_344165_.getUseItemRemainingTicks()) / 3.0F;
            }
        });

package net.beastguy.distantlandsmc.enchantment;

import com.mojang.serialization.MapCodec;
import net.beastguy.distantlandsmc.DistantLandsMod;
import net.beastguy.distantlandsmc.enchantment.custom.LightningStrikerEnchantmentEffect;
...
public class ModEnchantmentEffects {
    public static final DeferredRegister<MapCodec<? extends EnchantmentEntityEffect>> ENTITY_ENCHANTMENT_EFFECTS =
            DeferredRegister.create(Registries.ENCHANTMENT_ENTITY_EFFECT_TYPE, DistantLandsMod.MODID);

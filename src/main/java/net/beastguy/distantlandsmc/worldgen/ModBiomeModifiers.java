...
public class ModBiomeModifiers {
    ...
    public static final ResourceKey<BiomeModifier> ADD_SAND_DISK = registerKey("add_sand_disk");
    public static final ResourceKey<BiomeModifier> ADD_GRAVEL_DISK = registerKey("add_gravel_disk");
    public static final ResourceKey<BiomeModifier> ADD_CLAY_DISK = registerKey("add_clay_disk");
    ...
    */
        ...
        context.register(ADD_SAND_DISK, new BiomeModifiers.AddFeaturesBiomeModifier(
                HolderSet.direct(biomes.getOrThrow(ModBiomes.PURPLE_PLAINS)),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.SAND_DISK_PLACED_KEY)),
                GenerationStep.Decoration.VEGETAL_DECORATION));

        context.register(ADD_GRAVEL_DISK, new BiomeModifiers.AddFeaturesBiomeModifier(
                HolderSet.direct(biomes.getOrThrow(ModBiomes.PURPLE_PLAINS)),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.GRAVEL_DISK_PLACED_KEY)),
                GenerationStep.Decoration.VEGETAL_DECORATION));

        context.register(ADD_CLAY_DISK, new BiomeModifiers.AddFeaturesBiomeModifier(
                HolderSet.direct(biomes.getOrThrow(ModBiomes.PURPLE_PLAINS)),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.CLAY_DISK_PLACED_KEY)),
                GenerationStep.Decoration.VEGETAL_DECORATION));

...
public class ModSurfaceRules {
    ...
    public static SurfaceRules.RuleSource makePurplePlainsRules() {
        return SurfaceRules.sequence(
                SurfaceRules.ifTrue(SurfaceRules.isBiome(ModBiomes.PURPLE_PLAINS),
                        SurfaceRules.sequence(
                                SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, GRASS_BLOCK),      // Grama no chão
                                SurfaceRules.ifTrue(SurfaceRules.UNDER_FLOOR, DIRT)          // Terra embaixo
                        )
                )
        );
    }
